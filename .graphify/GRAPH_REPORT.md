...
## Corpus Check
- 131 files · ~266.472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 389 nodes · 800 edges · 19 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 182 · PARENT_OF: 181 · MODIFIES: 169 · contains: 107 · method: 73 · calls: 51 · imports: 37


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 131 · Candidates: 232
- Excluded: 1 untracked · 1447 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `8ccca63`
...
- `0065d03 chore(cleanup): remove 97 unused asset files, update metadata references, and optimize site production bundle` --ON_BRANCH--> `master`  [EXTRACTED]
  git → git  _Bridges community 12 → community 7_
...
- `0405449 fix(logo): restore white typography logo (logo_typography_light.webp) with enhanced drop-shadow for 100% legibility on both mobile and desktop` --ON_BRANCH--> `master`  [EXTRACTED]
  git → git  _Bridges community 5 → community 7_
...
Cohesion: 0.05
Nodes (45): checkAuth(), loadModules(), 0562814 docs: update design spec for Media Library and blog image integration, 084f7f6 docs: add walkthrough documentation, 1549879 docs: update implementation plan for unified samurai admin and real-time live sync, 1f0cf3c feat(opiniones): modulo CRUD en admin, galeria corregida y seccion de redes sociales (Instagram, YouTube, Facebook), 26bbdaa docs: update walkthrough for Media Library implementation, 2fcb02d fix: map admin section toggles and menu items to exact index.html DOM elements (+37 more)
...
Cohesion: 0.19
Nodes (19): master, 102b502 feat: add dynamic top 3 posts widget to home and 2-stage blog catalog and single post reader view, 16d9a6e docs: add design spec for admin backend, cms and user management, 1fe3520 feat(audio): implement traditional Japanese Shakuhachi procedural flute audio engine with Zen temple reverb, pitch bends, and header toggle, 28cd58f docs: update walkthrough for PocketBase cross-platform service, 4cfca8e docs: update walkthrough for PocketBase systemd daemon service, 5d50db6 docs: update design spec for Blog catalog and reader views, 61d9e54 docs: update design spec for Unified Node App server (+11 more)
...
Cohesion: 0.40
Nodes (5): 1c33ae2 docs: update walkthrough for Blog section implementation, 2e08ad4 docs: update walkthrough for Strapi integration, 7710994 docs: update plan for Strapi Headless CMS integration, 7af96be feat: integrate Strapi Headless CMS adapter and add backend provider selector, e4a2547 docs: update design spec for Strapi Headless CMS integration
