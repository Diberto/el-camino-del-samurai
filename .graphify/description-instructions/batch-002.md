...
- "public_blog_renderview": "renderView()" | kind=code-symbol | source=src/public/blog.js:L18 | neighbors=[blog.js, getTargetPostId(), renderCatalog(), renderSinglePost()] | lang=en
