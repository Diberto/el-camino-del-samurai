...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@90ed50e180119cbb1103a890f983e59c89fddad4": "90ed50e feat(admin): seccion y pestaña dedicada para gestion de Galeria Fotogra…" | kind=Commit | source=git | neighbors=[8ccca63 fix(media): carga y persistenci…, admin.js, master, gallery-manager.js, sections-menu-manager.js] | lang=es
