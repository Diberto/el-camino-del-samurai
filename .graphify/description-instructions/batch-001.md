...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@2fcb02d84ae80b7ec8bc67f52efded1c879a41ae": "2fcb02d fix: map admin section toggles and menu items to exact index.html DOM e…" | kind=Commit | source=git | neighbors=[master, bc1adc8 docs: update walkthrough docume…, sections-menu-manager.js, script.js, 6cb0334 docs: update walkthrough docume…] | lang=en
...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@a0744dc193c0cd8ad1f29116a9ffd706ffddba40": "a0744dc feat(storage): motor de persistencia nativo en disco (data/) para Hosti…" | kind=Commit | source=git | neighbors=[master, 8ccca63 fix(media): carga y persistenci…, server.js, native-store.js, cf9d01a feat(admin): modulo de diagnost…] | lang=es
...
- "modules_media_manager": "media-manager.js" | kind=code-symbol | source=src/admin/modules/media-manager.js:L1 | neighbors=[cf9d01a feat(admin): modulo de diagnost…, fd36f9a feat: add Media Library Manager…, initMediaManager(), dbService, convertToWebP()] | lang=en
...
- "script_sakurapetal": "SakuraPetal" | kind=code-symbol | source=script.js:L873 | neighbors=[script.js, .constructor(), .draw(), .reset(), .update()] | lang=en
- "services_native_store_handlenativedatastore": "handleNativeDataStore()" | kind=code-symbol | source=src/services/native-store.js:L191 | neighbors=[server.js, native-store.js, readBody(), readStore(), writeStore()] | lang=en
