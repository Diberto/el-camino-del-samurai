...
- "server_getsafebackupfilename": "getSafeBackupFilename()" | kind=code-symbol | source=server.js:L604 | neighbors=[server.js]
...
- "server_performbackupcreation": "performBackupCreation()" | kind=code-symbol | source=server.js:L416 | neighbors=[server.js]
...
- "server_servestaticfile": "serveStaticFile()" | kind=code-symbol | source=server.js:L335 | neighbors=[server.js]
- "server_startautobackupworker": "startAutoBackupWorker()" | kind=code-symbol | source=server.js:L520 | neighbors=[server.js]
- "server_startlistening": "startListening()" | kind=code-symbol | source=server.js:L580 | neighbors=[server.js]
- "server_system_logs": "SYSTEM_LOGS" | kind=code-symbol | source=server.js:L82 | neighbors=[server.js]
- "server_verifyauthtoken": "verifyAuthToken()" | kind=code-symbol | source=server.js:L613 | neighbors=[server.js]
