...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@86a8e0f5eb72fe39c505d407666265d5fa6d3ded": "86a8e0f feat(gallery): area independiente en admin con subida directa, selector…" | kind=Commit | source=git | neighbors=[master, gallery-manager.js, 90ed50e feat(admin): seccion y pestaña …] | lang=es
