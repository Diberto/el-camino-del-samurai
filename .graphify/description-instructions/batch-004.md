...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@94e9395ca47d2a8fb0673332d7c54c7d7d488157": "94e9395 fix(static): decodificacion de URLs con espacios (decodeURIComponent) y…" | kind=Commit | source=git | neighbors=[86a8e0f feat(gallery): area independien…, master, server.js] | lang=es
