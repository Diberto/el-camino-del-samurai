...
- "modules_sections_menu_manager": "sections-menu-manager.js" | kind=code-symbol | source=src/admin/modules/sections-menu-manager.js:L1 | neighbors=[1f0cf3c feat(opiniones): modulo CRUD en…, 2fcb02d fix: map admin section toggles …, 48d0413 feat: align admin shell with sa…, 8334dc5 feat: add Samurai Blog section …, 8ccca63 fix(media): carga y persistenci…, 94208da fix: auto-sync section toggles …] | lang=en
...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@8ccca63b7b4819eac7faf1c904743099c0104f4d": "8ccca63 fix(media): carga y persistencia real de imagenes en uploads/ y editor …" | kind=Commit | source=git | neighbors=[pocketbase-adapter.js, master, sections-menu-manager.js, script.js, native-store.js, a0744dc feat(storage): motor de persist…] | lang=en
