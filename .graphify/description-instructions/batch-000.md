...
- "admin_admin": "admin.js" | kind=code-symbol | source=src/admin/admin.js:L1 | neighbors=[checkAuth(), loadModules(), initBackupManager(), initBlogManager(), initDiagnosticsManager(), initGpuManager()] | lang=en
...
- "services_db_service_dbservice": "dbService" | kind=code-symbol | source=src/services/db-service.js:L38 | neighbors=[admin.js, wysiwyg-editor.js, backup-manager.js, blog-cms-manager.js, diagnostics-manager.js, gpu-config-manager.js] | lang=en
...
- "modules_sections_menu_manager": "sections-menu-manager.js" | kind=code-symbol | source=src/admin/modules/sections-menu-manager.js:L1 | neighbors=[1f0cf3c feat(opiniones): modulo CRUD en…, 2fcb02d fix: map admin section toggles …, 48d0413 feat: align admin shell with sa…, 8334dc5 feat: add Samurai Blog section …, 94208da fix: auto-sync section toggles …, c0749a0 feat: complete Admin Backend, C…] | lang=en
- "commit:repo:github.com/Diberto/el-camino-del-samurai@cf9d01a3762e0d24c89c7892f6db1ec3ae720e14": "cf9d01a feat(admin): modulo de diagnosticos/logs, configuracion de redes social…" | kind=Commit | source=git | neighbors=[6e84b4a feat(optimizations): mejoras de…, pocketbase-adapter.js, admin.js, master, diagnostics-manager.js, media-manager.js] | lang=nl
...
- "services_sync_service_syncservice": "SyncService" | kind=code-symbol | source=src/services/sync-service.js:L2 | neighbors=[backup-manager.js, blog-cms-manager.js, gpu-config-manager.js, sections-menu-manager.js, script.js, sync-service.js] | lang=en
...
- "commit:repo:github.com/Diberto/el-camino-del-samurai@1728be7acf680ca06a4652399e4794bccebdd2d8": "1728be7 fix: use raw SQL UPDATE query in migration and pre-launch to forcefully…" | kind=Commit | source=git | neighbors=[master, a3e96d1 fix: return 404 for missing sta…, 1700000001_unlock_collections.js, start-pocketbase.js, 6fcf262 feat: add 1700000001_unlock_col…] | lang=en
- "commit:repo:github.com/Diberto/el-camino-del-samurai@196097e02206d04f6ffd09376f16e0d8388f5b0a": "196097e fix: resolve PocketBase 400 Bad Request error by sending native json pa…" | kind=Commit | source=git | neighbors=[pocketbase-adapter.js, master, b552139 docs: update walkthrough for fi…, 1700000000_init_collections.js, c9842fa docs: update walkthrough for fi…] | lang=en
- "commit:repo:github.com/Diberto/el-camino-del-samurai@215584ed3b56eded5092827c2c6de8207d1d389e": "215584e fix: restore PocketBase as default backend provider and enable Dual Syn…" | kind=Commit | source=git | neighbors=[0390b13 docs: update walkthrough for sm…, pocketbase-adapter.js, master, 31f490d docs: update walkthrough for Po…, db-service.js] | lang=en
