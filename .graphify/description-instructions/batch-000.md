...
- "modules_gallery_manager": "gallery-manager.js" | kind=code-symbol | source=src/admin/modules/gallery-manager.js:L1 | neighbors=[90ed50e feat(admin): seccion y pestaña …, convertToWebP(), DEFAULT_GALLERY_ITEMS, initGalleryManager(), SUGGESTED_TAGS, dbService] | lang=en
