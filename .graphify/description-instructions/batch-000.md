...
- "services_native_store": "native-store.js" | kind=code-symbol | source=src/services/native-store.js:L1 | neighbors=[a0744dc feat(storage): motor de persist…, DATA_DIR, DEFAULT_MEDIA, DEFAULT_OPINIONS, DEFAULT_POSTS, DEFAULT_SETTINGS] | lang=en
