  ...
  container.innerHTML = `
    ...
    <div style="display: grid; gap: 2rem;">
      <div class="samurai-card" style="padding: 1.5rem;">
        ...
        <p style="color:var(--text-secondary); font-size:0.85rem; margin-bottom:1rem;">Activa o desactiva la visibilidad de cada sección de index.html en tiempo real:</p>
