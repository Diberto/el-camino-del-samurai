...
export class LocalSqliteAdapter {
  constructor() {
    this.storageKey = 'local_db_emulator_v4';
    if (!localStorage.getItem(this.storageKey)) {
      const defaultMedia = [
        {
          id: 'med-1',
          name: 'Jorge Orpianesi en Japón',
          url: 'photos/orpianesi1.webp',
          type: 'image/webp',
          size: '31.8 KB',
        ...
        },
        {
          ...
          url: 'photos/castillo_sengoku.webp',
          type: 'image/webp',
          size: '159.5 KB',
        ...
        },
        {
          ...
          url: 'photos/cueva_reigando.webp',
          type: 'image/webp',
          size: '229.7 KB',
