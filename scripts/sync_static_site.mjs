...
const opinionMsg = settings.whatsapp_opinion_msg || 'Hola Jorge, te envío mi opinión/foto sobre el libro de El Camino del Samurái';
const waPhone = (settings.whatsapp || '5493513886443').replace(/[^0-9]/g, '') || '5493513886443';
const waOpinionUrl = `https://wa.me/${waPhone}?text=${encodeURIComponent(opinionMsg)}`;
...
${opinionsHtml}
            ...
            <div class="reviews-cta-box center fade-in">
                ...
                <a href="${e(waOpinionUrl)}" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-whatsapp-cta">
